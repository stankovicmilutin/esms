...
<div class="row">
    <div class="col-md-6 col-md-offset-3 ">
        <div class="well">
        {{ Form::open(array('url' => URL::route('editTeamData', $team->teamID), 'files' => true )) }}
        <div class="form-group">
            <label for="image">Team Photo (140x140):</label>
        ...
        <div class="form-group">
            ...
            <input type="text" class="form-control" id="teamname" name="teamname" placeholder="Enter Team Name" value="{{$team->name}}" >
            @if($errors->has('teamname'))
            <label class="text-danger" for="teamname">
        ...
        <div class="form-group">
            ...
            <input type="text" class="form-control" id="teamtag" name="teamtag" placeholder="Enter Team Tag" value="{{$team->tag}}" >
            @if($errors->has('teamtag'))
            <label class="text-danger" for="teamname">
                {{ $errors->first('teamtag') }}
            </label>
            @endif 
        </div>
        <div class="form-group">
            <label for="about">About</label>
            <textarea class="form-control" id="about" name="about" placeholder="Enter few lines about your team.">{{$team->about}}</textarea>
            @if($errors->has('about'))
        ...
        <div class="form-group">
            ...
            <input type="text" class="form-control" id="facebook" name="facebook" placeholder="Enter Facebook Link" value="{{$team->facebook}}" >
            @if($errors->has('facebook'))
            <label class="text-danger" for="facebook">
    	...
    	<div class="form-group">
            ...
            <option value="Antarctica" <?php if($country=="Antarctica"){ echo 'selected="selected"';}?> >Antarctica</option>
            ...
            <option value="Bosnia and Herzegovina" <?php if($country=="United"){ echo 'selected="selected"';}?> >Bosnia and Herzegovina</option>
            <option value="Botswana" <?php if($country=="Bosnia and Herzegovina"){ echo 'selected="selected"';}?> >Botswana</option>
            ...
            <option value="Congo, The Democratic Republic of The" <?php if($country=="Congo, The Democratic Republic of The"){ echo 'selected="selected"';}?> >Congo, The Democratic Republic of The</option>
            ...
            <option value="Falkland Islands (Malvinas)" <?php if($country=="Falkland Islands (Malvinas)"){ echo 'selected="selected"';}?> >Falkland Islands (Malvinas)</option>
            ...
            <option value="Heard Island and Mcdonald Islands" <?php if($country=="Heard Island and Mcdonald Islands"){ echo 'selected="selected"';}?> >Heard Island and Mcdonald Islands</option>
            <option value="Holy See (Vatican City State)" <?php if($country=="Holy See (Vatican City State)"){ echo 'selected="selected"';}?> >Holy See (Vatican City State)</option>
            ...
            <option value="Iran, Islamic Republic of" <?php if($country=="Iran, Islamic Republic of"){ echo 'selected="selected"';}?> >Iran, Islamic Republic of</option>
            ...
            <option value="Korea, Democratic Peoples Republic of" <?php if($country=="Korea, Democratic People's Republic of"){ echo 'selected="selected"';}?> >Korea, Democratic People's Republic of</option>
            ...
            <option value="Lao Peoples Democratic Republic" <?php if($country=="Lao People's Democratic Republic"){ echo 'selected="selected"';}?> >Lao People's Democratic Republic</option>
            ...
            <option value="Macao" <?php if($country=="Macao"){ echo 'selected="selected"';}?> >Macao</option>
            <option value="Macedonia, The Former Yugoslav Republic of" <?php if($country=="Macedonia, The Former Yugoslav Republic of"){ echo 'selected="selected"';}?> >Macedonia, The Former Yugoslav Republic of</option>
            ...
            <option value="Micronesia, Federated States of" <?php if($country=="Micronesia, Federated States of"){ echo 'selected="selected"';}?> >Micronesia, Federated States of</option>
            ...
            <option value="Palestinian Territory, Occupied" <?php if($country=="Palestinian Territory, Occupied"){ echo 'selected="selected"';}?> >Palestinian Territory, Occupied</option>
            ...
            <option value="Saint Pierre and Miquelon" <?php if($country=="Saint Pierre and Miquelon"){ echo 'selected="selected"';}?> >Saint Pierre and Miquelon</option>
            <option value="Saint Vincent and The Grenadines" <?php if($country=="Saint Vincent and The Grenadines"){ echo 'selected="selected"';}?> >Saint Vincent and The Grenadines</option>
            ...
            <option value="South Georgia and The South Sandwich Islands" <?php if($country=="South Georgia and The South Sandwich Islands"){ echo 'selected="selected"';}?> >South Georgia and The South Sandwich Islands</option>
            ...
            <option value="Svalbard and Jan Mayen" <?php if($country=="Svalbard and Jan Mayen"){ echo 'selected="selected"';}?> >Svalbard and Jan Mayen</option>
            ...
            <option value="Taiwan, Province of China" <?php if($country=="Taiwan, Province of China"){ echo 'selected="selected"';}?> >Taiwan, Province of China</option>
            <option value="Tajikistan" <?php if($country=="Tajikistan"){ echo 'selected="selected"';}?> >Tajikistan</option>
            <option value="Tanzania, United Republic of" <?php if($country=="Tanzania, United Republic of"){ echo 'selected="selected"';}?> >Tanzania, United Republic of</option>
            <option value="Thailand" <?php if($country=="Thailand"){ echo 'selected="selected"';}?> >Thailand</option>
            <option value="Timor-leste" <?php if($country=="Timor-leste"){ echo 'selected="selected"';}?> >Timor-leste</option>
            ...
            <option value="United Kingdom" <?php if($country=="United Kingdom"){ echo 'selected="selected"';}?> >United Kingdom</option>
            <option value="United States Minor Outlying Islands" <?php if($country=="United States Minor Outlying Islands"){ echo 'selected="selected"';}?> >United States Minor Outlying Islands</option>
            ...
            <option value="Wallis and Futuna" <?php if($country=="Wallis and Futuna"){ echo 'selected="selected"';}?> >Wallis and Futuna</option>
